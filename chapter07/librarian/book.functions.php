...
function saveAuthor($lastName, $middleName, $firstName)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $saved = saveAuthorInCollection($lastName, $middleName, $firstName);                    
    }
    return $saved;
}
...
function getAuthorByCode($code)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $author = readAuthorInCollectionByCode($code);            
    }
    if (empty($author)){
        $author = [
            'first_name' => '',
...
function updateAuthor($code, $lastName, $middleName, $firstName)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $saved = updateAuthorInCollection($code, $data);
    }
    return $saved;
}
...
function deleteAuthor($code)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $deleted = deleteAuthorInCollection($code);            
    }
    return $deleted;
}
...
function saveBook($title, $authorCode)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $saved = saveBookInCollection($title, $authorCode);
    }
    return $saved;
}
...
function getBookByCode($code)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $book = readBookInCollectionByCode($code);            
    }
    if (empty($book)){
        $book = [
            'title' => '',
...
function updateBook($code, $title, $authorCode)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $saved = updateBookInCollection($code, $data);
    }
    return $saved;
}
...
function deleteBook($code)
{
    ...
    switch($storageFormat){
        ...
        case 'rdb':
            ...
            break;
        case 'ddb':
            $deleted = deleteBookInCollection($code);            
    }
    return $deleted;
}
