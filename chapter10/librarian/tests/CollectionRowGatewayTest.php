...
if (!class_exists(CollectionTest::class)){
    require_once 'CollectionTest.php';
}
/**
 * @covers AuthorCollectionRowGateway
 * @covers BookCollectionRowGateway
 ...
 * @covers BookRowSet
 */
#[CoversClass(AuthorCollectionRowGateway::class)]
#[CoversClass(BookCollectionRowGateway::class)]
