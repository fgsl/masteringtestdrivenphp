...
class ViewJSONTest extends AbstractBackupTest
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        replaceConfigFileContent("'storage_format' => 'txt'","'storage_format' => 'json'");
    ...
    public static function tearDownAfterClass():void
    {
        ...
        replaceConfigFileContent("'storage_format' => 'json'","'storage_format' => 'txt'");
